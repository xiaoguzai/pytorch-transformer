...
bert,bertconfig,get_data = get_model_function('nezha-base')
...
for current_split in range(split_n):
    ...
    bertmodel = get_data(bertmodel,'/home/xiaoguzai/模型/nezha-base/pytorch_model.bin')
    model = ClassificationModel(bertmodel,config,n_label)
    #初始化模型:易漏
...
with open(r'/home/xiaoguzai/程序/剧本角色情感识别/训练数据/多折换主语为中文fgm对抗'+str(split_n)+'折融合nezha+seed='+str(seed)+'.csv','w') as f:
